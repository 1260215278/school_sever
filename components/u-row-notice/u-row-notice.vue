<template>
	<view class="u-notice-bar">
		<view class="u-direction-row">
			<view class="u-icon-wrap"><image src="/static/second-phase/volume-icon.png" class="volume-icon"></image></view>
			<view class="u-notice-box" id="u-notice-box">
				...
				>
					<text class="u-notice-text" space="nbsp" @tap="click">{{ showText }}</text>
				</view>
			</view>
		</view>
	</view>
